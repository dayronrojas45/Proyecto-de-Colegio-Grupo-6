    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        return http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(HttpMethod.GET, "/api/profesores/**").hasAnyRole("ADMIN", "PROFESOR", "ALUMNO")
                        ...
                        .requestMatchers(HttpMethod.GET, "/api/alumnos/**").hasAnyRole("ADMIN", "PROFESOR", "ALUMNO")
